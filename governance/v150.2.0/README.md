...
- exact Debian Bookworm libclang, LLVM, and Z3 runtime packages by URL, version,
  size, and SHA-256 for offline bindgen, with their source package URLs retained;
